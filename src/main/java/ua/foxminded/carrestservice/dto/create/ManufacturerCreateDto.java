...
/**
 * Data Transfer Object (DTO) for creating a new manufacturer in the car rest service system.
 * Extends {@link AbstractCreateDto} to inherit common DTO structure. Contains the manufacturer's
...
@ToString
@SuperBuilder
public class ManufacturerCreateDto extends AbstractCreateDto {
